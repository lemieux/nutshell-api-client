  ...
  async.waterfall([
    ...
    function setupApi(options, cb) {
      let api = {
        ...
        /**
         * Get entities.
         * @param  {string}   entity - The entity type to be found.
         * @param  {string}   args.entity - The entity type to be found.
         * @param  {string}   [args.qty=50] - The number of results to return.
         * @param  {string}   [args.filter] - The property name to filter on.
         * @param  {Object}   [args.query] - A query object to use.
         ...
         * @return {void}
         */
        get(entity, entityId, cb) {
          if (!entity) {
            cb(new Error('Must pass in an entity name.'));
          }

          let payload = {
            method : `get${entity[0].toUpperCase()}${entity.slice(1)}`,
            params : {
              stubResponses : false
            },
            id : id.create()
          };
          payload.params[`${entity[0].toLowerCase()}${entity.slice(1)}Id`] = entityId;
